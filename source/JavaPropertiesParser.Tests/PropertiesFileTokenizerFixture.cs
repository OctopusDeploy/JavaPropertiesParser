    ...
    public class PropertiesFileTokenizerFixture
    {
        ...
        public void CanParseFileWithMultipleLinesAndComments()
        {
            RunTest(
                ...
                (TokenType.Separator, ": "),
                (TokenType.ValueChars, "another value "),
                (TokenType.Whitespace, "\r\n"),
                ...
                (TokenType.Separator, " : "),
                (TokenType.ValueChars, "third value"),
                (TokenType.Whitespace, "\r\n"),
                ...
                (TokenType.Separator, "=     "),
                (TokenType.ValueChars, "fourth value"),
                (TokenType.Whitespace, "\r\n"),
                ...
                (TokenType.KeyEscapeSequence, "\\="),
                (TokenType.Separator, "="),
                (TokenType.ValueChars, "fifth value"),
                (TokenType.Whitespace, "\r\n")
            );
        }
