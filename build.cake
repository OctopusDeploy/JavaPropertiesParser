...
var packageName = "JavaPropertiesParser";
...
Setup(context =>
{
    ...
    Information("Building Java Properties Parser v{0}", nugetVersion);
...
Task("Build")
    ...
    .Does(() =>
    {
        DotNetCoreBuild("./source/JavaPropertiesParser.sln", new DotNetCoreBuildSettings
        {
...
Task("Pack")
    ...
    .Does(() =>
    {
        DotNetCorePack("./source/JavaPropertiesParser", new DotNetCorePackSettings
        {
            Configuration = configuration,
